...
<%--    400 : 파라미터가없음 잘못됨, 404 : 리소스가없음, 405 : 리소스는 있는데 메소드가 구현안됨--%>
    ...
    <form method="post" action="./register.do">
        <p><label for="empno">사번 : </label><input id="empno" type="text" value="3333" name="empno"></p>
        <p><label> 이름 : <input name="ename" value="테스트" type="text"></label></p>
        <p><label> 직책 : <input name="job" type="text"></label></p>
        <p><label> 상사 : <input name="mgr" type="text" value="7788"></label></p>
        <p><label> 급여 : <input name="sal" value="1000.00" type="text"></label></p>
        <p><label> 상여급 : <input name="comm" type="text"></label></p>
        <p><label> 부서번호 : <input name="deptno" type="text"></label></p>
        <p><label> 입사일 : <input name="hiredate" type="date" value="2025-11-04"></label></p>
        <p>
